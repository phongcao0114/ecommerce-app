...
-- Insert category
INSERT INTO category (name) VALUES ('Waxworks') ON DUPLICATE KEY UPDATE name=name;

-- Get the waxworks category ID
SET @waxworks_id = (SELECT id FROM category WHERE name = 'Waxworks' LIMIT 1);

-- Insert products
INSERT INTO product (description, image_url, name, price, stock, category_id) VALUES
